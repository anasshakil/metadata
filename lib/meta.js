...
import { _checkTmpFile, _isReadableStream, _isURL } from "./utils/utils.js";
...
/**
 * @param {string | import("node:fs").ReadStream} file If you're directly passing a network stream make sure to set the cache_stream option to true, otherwise the temporary file will be deleted after reading the metadata.
