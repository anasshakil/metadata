...
import { _checkTmpFile, _createTempFolder, _isReadableStream, _isURL, __create_path, __rmTempFiles } from "./utils/utils.js";
...
export async function __w__(file, options = {}) {
    ...
    try {
        ...
        const { files, cache: __cache } = await __linear_path(file, { ...options, batch: { write: {} } });
        _cache = __cache;
        let _metadata_ = {
            pre: null,
            new: null,
